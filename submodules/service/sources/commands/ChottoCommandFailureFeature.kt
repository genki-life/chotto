...
internal object ChottoCommandFailureFeature : ApplicationFeature<ApplicationCallPipeline, Unit, Unit> {

	private val log = LoggerFactory.getLogger(ChottoCommandFailureFeature::class.java)!!
	...
	private suspend fun ApplicationCall.respondWithFailure(failure: ChottoCommandFailure, status: HttpStatusCode) {
