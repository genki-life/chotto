...
internal class ChottoEntityResolvingJSONEncoder<Transaction : ChottoTransaction>(
	...
	companion object {
		...
		private val log = LoggerFactory.getLogger(ChottoEntityResolvingJSONEncoder::class.java)!!
	}
}
