...
class PasswordHasher(
	...
	private fun verifyPassword(password: CharArray, expectedHash: PasswordHash): Boolean {
		val params = expectedHash.value.split(":".toRegex()).dropLastWhile { it.isEmpty() }.toTypedArray()
	...
	companion object {
		...
		private const val HASH_SECTIONS = 5
		private const val HASH_ALGORITHM_INDEX = 0
		private const val ITERATION_INDEX = 1
		private const val HASH_SIZE_INDEX = 2
		private const val SALT_INDEX = 3
		private const val PBKDF2_INDEX = 4
	}
}
